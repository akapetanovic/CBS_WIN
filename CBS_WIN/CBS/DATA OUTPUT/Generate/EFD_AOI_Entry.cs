...
namespace CBS
{
    class EFD_AOI_Entry
    {
        ...
        public static void Generate_Output (EFD_Msg Message_Data)
        {
                ...
                "<Placemark>" + Environment.NewLine +
                    ...
                    "<Data name=\"dataSourceName\">" + Environment.NewLine +
                        ...
                        "<Data name=\"popupLine1\">" + Environment.NewLine +
                            "<value>Time:{TIME}</value>" + Environment.NewLine +
                        "</Data>" + Environment.NewLine +
                        
                        "<Data name=\"popupLine2\">" + Environment.NewLine +
                            "<value>Point:{LON,LAT}</value>" + Environment.NewLine +
                        "</Data>" + Environment.NewLine +
                        
                        "<Data name=\"popupLine3\">" + Environment.NewLine +
                            "<value>Altitude:{Altitude}</value>" + Environment.NewLine +
                        "</Data>" + Environment.NewLine +
                        
                        "<Data name=\"fileLocation\">" + Environment.NewLine +
                            "<value>flights/ACID_IFPLID_DATETIME/EFD/EFD_AOI_Entry_DATETIME.kml</value>" + Environment.NewLine +
                        "</Data>" + Environment.NewLine +
            ...
            File_Path = Path.Combine(File_Path, ("EFD_AOI_Entry_" + CBS_Main.GetDate_Time_AS_YYYYMMDDHHMMSS(DateTime.UtcNow) + ".kml"));

            // Save data in the tmp directory first
            string Tmp = Path.Combine(CBS_Main.Get_Temp_Dir(), ("EFD_AOI_Entry_" + CBS_Main.GetDate_Time_AS_YYYYMMDDHHMMSS(DateTime.UtcNow) + ".kml"));
